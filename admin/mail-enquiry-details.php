...
if(isset($_POST['update']))
{
  ...
  {    
    ...
    $sql="UPDATE mail_enquiry set assignedAdminId=:aid,assignedAdminName=:aname,enquiryAssignedDate=:cdate,enquiryStatus=:status where enquiryid=:eid and enquiryStatus=:st";
  ...
  if(!empty($aef))
  {
    date_default_timezone_set("Asia/Kolkata");
    $cdate=date('d-m-Y H:m:s');
    $sql="UPDATE mail_enquiry set adminEnquiryFeedback=:aef,enquiryClosedDate=:cdate,enquiryStatus=:status where enquiryid=:eid and enquiryStatus=:st";
    $query = $dbh->prepare($sql);
                    ...
                    <div class="panel-body">
                      <form method="post" class="form-horizontal">
                        ...
                        <?php 
                          $id=$_GET['eid'];
                          $st=$_GET['st'];
                          $sql="SELECT * from mail_enquiry where enquiryid=:id and enquiryStatus=:st";
                          $query = $dbh->prepare($sql);
                          $query->bindParam(':st',$st,PDO::PARAM_STR);                  
