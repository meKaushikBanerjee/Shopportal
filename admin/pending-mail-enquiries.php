...
<?php include('includes/sidebar.php'); ?>
    <div class="content-wrapper">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <h2 class="page-title">Open Enquiry</h2>
            <div class="table-responsive">
              <table id="zctb" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  <?php 
                    $sql="SELECT * from mail_enquiry where enquiryStatus=0";
                  ...
                  ?>
                        <tr>
                          ...
                          <td><a href="mail-enquiry-details.php?eid=<?php echo $result->enquiryid;?>&st=<?php echo $result->enquiryStatus;?>"><i class="fa fa-edit"></i></a></td>
                        </tr>
                  <?php
                      }
                    } 
